...
export class MonacoLanguages implements Languages {
        ...
        return {
            ...
            provideCompletionItems: (model, position, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asCompletionResult(result));
            },
            resolveCompletionItem: provider.resolveCompletionItem
                ? (item, token) => {
                      const protocolItem = this.m2p.asCompletionItem(item);
                      return provider.resolveCompletionItem!(protocolItem, token).then(
                          item => this.p2m.asCompletionItem(item)
                      );
                  }
                : undefined,
        };
        ...
        return {
            provideHover: (model, position, token) => {
                ...
                return provider
                    ...
                    .then(hover => this.p2m.asHover(hover));
            },
        };
    }
        ...
        return {
            provideDefinition: (model, position, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asDefinitionResult(result));
            },
        };
    }
        ...
        return {
            provideReferences: (model, position, context, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asReferences(result));
            },
        };
    }
    ...
    registerDocumentHighlightProvider(
        ...
        const documentHighlightProvider = this.createDocumentHighlightProvider(
            selector,
            provider
        );
        const providers = new DisposableCollection();
        ...
        return {
            provideDocumentHighlights: (model, position, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asDocumentHighlights(result));
            },
        };
    }
    ...
    registerDocumentSymbolProvider(
        ...
        const documentSymbolProvider = this.createDocumentSymbolProvider(
            selector,
            provider
        );
        const providers = new DisposableCollection();
        ...
        return {
            provideDocumentSymbols: (model, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asSymbolInformations(result));
            },
        };
    }
        ...
        return {
            provideCodeActions: (model, range, context, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asCommands(result));
            },
        };
    }
        ...
        return {
            provideCodeLenses: (model, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asCodeLenses(result));
            },
            resolveCodeLens: provider.resolveCodeLens
                ? (model, codeLens, token) => {
                      ...
                      return provider.resolveCodeLens!(protocolCodeLens, token).then(
                          result => this.p2m.asCodeLens(result)
                      );
                  }
                : undefined,
        };
        ...
        return {
            provideDocumentFormattingEdits: (model, options, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asTextEdits(result));
            },
        };
    }
    ...
    registerDocumentRangeFormattingEditProvider(
        ...
        const documentRangeFormattingEditProvider = this.createDocumentRangeFormattingEditProvider(
            selector,
            provider
        );
        const providers = new DisposableCollection();
    ...
    createDocumentRangeFormattingEditProvider(
        ...
        return {
            provideDocumentRangeFormattingEdits: (model, range, options, token) => {
                ...
                const params = this.m2p.asDocumentRangeFormattingParams(
                    model,
                    range,
                    options
                );
    ...
    registerOnTypeFormattingEditProvider(
        ...
        const onTypeFormattingEditProvider = this.createOnTypeFormattingEditProvider(
            selector,
            provider,
    ...
    protected createOnTypeFormattingEditProvider(
        selector: DocumentSelector,
        provider: OnTypeFormattingEditProvider,
        firstTriggerCharacter: string,
        ...moreTriggerCharacter: string[]
    ): monaco.languages.OnTypeFormattingEditProvider {
        const autoFormatTriggerCharacters = [firstTriggerCharacter].concat(
            moreTriggerCharacter
        );
        return {
            ...
            provideOnTypeFormattingEdits: (model, position, ch, options, token) => {
                ...
                const params = this.m2p.asDocumentOnTypeFormattingParams(
                    model,
                    position,
                    ch,
                    options
        ...
        return {
            provideRenameEdits: (model, position, newName, token) => {
                ...
                return provider
                    ...
                    .then(result => this.p2m.asWorkspaceEdit(result));
            },
        };
    }
